...
|---|---|
| ![Reviews](reviews.png) | ![Payment](history.png) |

---

## Features

- **Admin Dashboard** — Summary cards for total products, orders, low stock, suppliers, and categories. Auto-refreshes on return from any module.
...
- **Role-Based Access** — UI adjusts automatically based on role (Admin / Logistics)
